...
const devolverRecomendados = () => {
  $.ajax({
    url: ruta_devolver_recomendados,
    type: "POST",
    data: {
      pagina: pagina,
    },
          ...
          if ($(`#textarea-${id}`).val().length == 0) {
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                }</span> · <ion-icon data-com='${data.comentario.id}' class='${
                  data.comentario.le_gusta ? "has-text-danger" : "has-text-gray"
